...
<form action="updatePwd" method="post" class="form-signin">

 <div class="text-center mb-4">
			<!--     <img class="mb-4" src="/docs/4.2/assets/brand/bootstrap-solid.svg" alt="" width="72" height="72"> -->
			<h1 class="h3 mb-3 font-weight-normal">變更密碼</h1>
		</div>


            <div class="form-label-group">
			<input type="text" id="oldMemberPwd" name="oldPwd"
				class="form-control" placeholder="Password" required> 
				<label for="inputPassword">請輸入舊密碼 :</label>
				<small style="color: red">${errorOldPwd}${errorPwd}</small>
				<small id="oldMemberPwdRegular" class="text-danger"></small><br>
		    </div>
