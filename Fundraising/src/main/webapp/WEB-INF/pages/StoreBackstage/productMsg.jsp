...
<!--           </li> -->
  ...
  <div class="container">
    ...
    <div class="card gedf-card">
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="ml-2">
                                    <div class="h5 m-0">@${getListMsg.member.memberEmail} <span><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#replyMsg${getListMsg.msgId}"><i class="fa fa-comment"></i>Reply</button>
                    	<input type="hidden" value="${getListMsg.msgId}" name="msgId">
	 					<input type="hidden" value="${getListMsg.product.productId}" name="productId"></span></div>
                                    <div class="h7 text-muted">${getListMsg.member.memberFname}</div>
                                </div>
                            </div>
                            <div>
                    ...
                    <div class="card-body">
                        <div class="text-muted h7 mb-2"> <i class="fa fa-clock-o"></i>${getListMsg.msgDate}</div>
                        <a class="card-link" href="#">
                            <h5 class="card-title">${getListMsg.msgTital}</h5>
                        </a>
		...
		<c:if test="${listReply.msg.msgId == getListMsg.msgId}"><!-- 如果ID相同 -->			
			<div class="card-header">
				<div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="mr-2">
                                    <img class="rounded-circle" width="45" src="${listReply.store.storePic}" alt="">
                                </div>
                                <div class="ml-2">
