...
public class ExampleAllInOne {
	...
	/*
	 * 
	 * 若不需要發票資訊請將String form = all.aioCheckOut(obj, null);設定為null，
	 * 否則系統會跳出CheckValueError。
	 * 
	 */
...
//		System.out.println("aioCheckOutBARCODE: " + genAioCheckOutBARCODE());//超商繳費
//		System.out.println("aioCheckOutDevide: " + genAioCheckOutDevide());
//		System.out.println("aioCheckOutOneTime: " + genAioCheckOutOneTime());//信用卡一次付清
...
// 	System.out.println("aioCheckOutWebATM: " + genAioCheckOutWebATM());
	...
	public static String genAioCheckOutWebATM() {
		...
		obj.setMerchantTradeNo("testCompany004444");
	...
	public static String genAioCheckOutCVS() {
		...
		obj.setTradeDesc("testDescription");
		obj.setItemName("TestItem");
		obj.setReturnURL("http://211.23.128.214:5000");
		obj.setNeedExtraPaidInfo("N");
		obj.setStoreExpireDate("3");
		...
		invoice.setInvoiceItemPrice("500");
	...
	public static String genAioCheckOutPeriod() {
		...
		obj.setMerchantTradeNo("QWEASDZXC987321");
		obj.setMerchantTradeDate("2017/01/01 08:05:23");
		obj.setTotalAmount("50");
		obj.setTradeDesc("test Description");
		obj.setItemName("TestItem");
		...
		obj.setFrequency("1");
		obj.setExecTimes("12");
		// 將invoice(aioCheckOut)設為null，否則實行頁面會跳出CheckValueError!!!
		String form = all.aioCheckOut(obj, null);
		return form;
	}
}
